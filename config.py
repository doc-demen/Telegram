...
class Config(object):
    log = True
    APP_ID = getenv("API_ID", "20414162")
    API_HASH = getenv("API_HASH", "d76fe451e4a8d163a0468b5da1fb4233")
    TOKEN = getenv("TOKEN", "")
    ...
    MESSAGE_DUMP = getenv("MESSAGE_DUMP", "-1001749823528")
    GBAN_LOGS = getenv("GBAN_LOGS", "-1001749823528")
    SYS_ADMIN = getenv("SYS_ADMIN", "1128350486")
    DEV_USERS = getenv("DEV_USERS", "1128350486")
    LOAD = getenv("LOAD")
    WEBHOOK = False
    SPB_MODE = True
    DROP_UPDATES = False
    ...
    ALLOW_EXCL = True
    CUSTOM_CMD = False
    CHANNEL = getenv("CHANNEL", "KK_KanimangalamKovilakam")
    SUPPORT = getenv("SUPPORT", "KK_KanimangalamKovilakam")
    ...
    SUDO_USERS = list(map(int, getenv("SUDO_USERS", "1128350486").split()))
    ZAID_USER = list(map(int, getenv("DEV_USERS", "1128350486").split()))
